const { solution } = require("./0-Unrepeatable");
const { Loop } = require("./10-Estructures");
const { IndexBox, updateBox, updateCol, updateRow } = require("./12-Update");
const { updateEvery } = require("./14-Global");
const { updateQubsBy } = require("./16-UpdateQubsBy");
const { boxs_to_squares } = require("./19-RCBtoSquares");
const { RestoreEstructures } = require("./25-Generate");
